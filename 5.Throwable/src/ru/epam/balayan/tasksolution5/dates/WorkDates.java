    ...
    public LocalDateTime getStartDate(String taskDate, DateTimeFormatter formatter) {
        if (taskDate == null) {
            throw new NullPointerException("No data in task date. Indicate date!");
                ...
                && taskDate.contains(".") && taskDate.contains(":") && taskDate.contains(" "))) {
        ...
        try {
            ...
            StringBuilder errTaskDateFormatMessage = new StringBuilder("\"").append(e.getParsedString())
                    .append("\"").append(" is invalid task date format! Use format: \"dd.MM.yyyy HH:mm\"");
